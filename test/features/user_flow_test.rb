...
def sign_in_user
  ...
  fill_out_and_submit_login_form_with_valid_user_credentials
end

def valid_user
  User.create!(email: 'me@example.com',
               password: 'a_great_password',
               password_confirmation: 'a_great_password')
end

def fill_out_and_submit_login_form_with_valid_user_credentials
  valid_user
  within '#new_user' do
